...
SOURCEFILES_QUOTED_IF_SPACED=Interrupt.c LCD.c main.c USART.c ADC.c ReadSignal.c Buzzer.c TOCTOC.c PWM.c I2C.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/USART.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/ReadSignal.p1 ${OBJECTDIR}/Buzzer.p1 ${OBJECTDIR}/TOCTOC.p1 ${OBJECTDIR}/PWM.p1 ${OBJECTDIR}/I2C.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Interrupt.p1.d ${OBJECTDIR}/LCD.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/USART.p1.d ${OBJECTDIR}/ADC.p1.d ${OBJECTDIR}/ReadSignal.p1.d ${OBJECTDIR}/Buzzer.p1.d ${OBJECTDIR}/TOCTOC.p1.d ${OBJECTDIR}/PWM.p1.d ${OBJECTDIR}/I2C.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/USART.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/ReadSignal.p1 ${OBJECTDIR}/Buzzer.p1 ${OBJECTDIR}/TOCTOC.p1 ${OBJECTDIR}/PWM.p1 ${OBJECTDIR}/I2C.p1

# Source Files
SOURCEFILES=Interrupt.c LCD.c main.c USART.c ADC.c ReadSignal.c Buzzer.c TOCTOC.c PWM.c I2C.c
...
${OBJECTDIR}/ReadSignal.p1: ReadSignal.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/ReadSignal.p1.d 
	@${RM} ${OBJECTDIR}/ReadSignal.p1 
...
${OBJECTDIR}/TOCTOC.p1: TOCTOC.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/TOCTOC.p1.d 
	@${RM} ${OBJECTDIR}/TOCTOC.p1 
...
dist/${CND_CONF}/${IMAGE_TYPE}/USART.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/USART.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=none  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/USART.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/USART.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/USART.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/USART.X.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/USART.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
